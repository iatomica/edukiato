...
export const Courses: React.FC<CoursesProps> = ({ onViewChange, onCourseSelect, userRole }) => {
  ...
  const handleCreateCourse = (e: React.FormEvent) => {
    ...
    // Trigger cross-module side-effects (calendar, feed, chat, notification)
          ...
          <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-scale-in">
            ...
            <form onSubmit={handleCreateCourse} className="p-6 space-y-4">
              ...
              <div className="pt-4 flex justify-end gap-3">
                <button type="button" onClick={() => setIsCreateOpen(false)} className="px-4 py-2 text-slate-500 font-medium hover:text-slate-700">
