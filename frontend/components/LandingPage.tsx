    ...
    <div className="min-h-screen bg-[#FDFBF7] font-sans overflow-x-hidden selection:bg-rose-300 selection:text-slate-900">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-rose-100 text-rose-600 font-bold text-sm mb-6 shadow-sm">
                <Star size={16} fill="currentColor" /> Diseñado para Educación Inicial
              </div>
              <h1 className="text-5xl sm:text-6xl lg:text-[4.5rem] font-black text-slate-800 tracking-tight leading-[1.1] mb-8">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-amber-400">tu Jardín Infantil</span>
              </h1>
              <p className="text-xl sm:text-2xl text-slate-500 mb-10 max-w-2xl mx-auto lg:mx-0 font-medium leading-relaxed">
                Asistencia, pagos, agendas y comunicaciones centralizadas en una sola app, súper fácil, limpia y amigable para maestras y padres.
              </p>
      ...
      <section className="py-24 bg-white/50 px-4 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24 relative z-10">
            ...
            <p className="text-xl text-slate-500 max-w-2xl mx-auto font-medium">Reemplazamos el cuaderno de comunicados tradicional por una experiencia que une al jardín con la familia.</p>
          </div>
          ...
          <div className="space-y-32">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
              <div className="w-full lg:w-1/2 relative group">
                ...
                <img src="/kinder_story.png" alt="Seño leyendo un cuento" className="relative w-full h-[400px] object-cover rounded-[3rem] border-8 border-white shadow-xl z-10" />
              </div>
              <div className="w-full lg:w-1/2">
                ...
                <p className="text-lg text-slate-500 leading-relaxed font-medium">Lleva el registro de asistencia en un tap, conoce qué profesionales están a cargo y archiva fotos o anécdotas del día para que los padres nunca se pierdan un momento mágico.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
              <div className="w-full lg:w-1/2 relative group">
                ...
                <img src="/kinder_painting.png" alt="Niña pintando" className="relative w-full h-[400px] object-cover rounded-[3rem] border-8 border-white shadow-xl z-10" />
              </div>
              <div className="w-full lg:w-1/2">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-32">
            <div className="p-10 rounded-[3rem] bg-amber-50 border-4 border-white shadow-xl hover:shadow-amber-100/50 transition-all flex flex-col items-center text-center">
              ...
              <p className="text-lg text-slate-600 font-medium">Eventos, cumpleaños y actos divididos por salita. Organización visual súper fácil.</p>
            </div>
      ...
      <section className="py-32 px-4 bg-sky-400 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-white">
          <h2 className="text-5xl lg:text-6xl font-black mb-8 leading-tight">Es hora de jugar<br/> a lo grande.</h2>
